...
export default function RegisterForm() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!isEmailValid || !isPasswordValid) {
      setWarning("Pastikan email dan password memenuhi syarat.");
      return;
    }
    ...
    // Call Supabase authentication for registration
    ...
    alert("Pendaftaran berhasil! Silakan periksa email Anda (jika konfirmasi diaktifkan), atau Anda dapat langsung masuk.");
    router.push("/");
    setLoading(false);
  };
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            ...
            <div className="pt-4">
              <button
                type="submit"
                disabled={loading}
                className="w-full h-12 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 disabled:bg-green-300"
              >
            ...
            <div className="flex justify-center items-center pt-2">
              ...
              <Link href="/" className="text-sm text-[#4D6BFE] hover:underline">
                Log in
              </Link>
            </div>
